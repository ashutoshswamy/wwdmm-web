      ...
      <div className="mx-auto max-w-6xl px-6 pb-20 pt-16 lg:pt-20">
        ...
        >
          <div className="flex flex-col gap-8">
            <span className="hero-reveal inline-flex w-fit items-center gap-2 rounded-full border border-mist px-3 py-1 font-mono text-xs uppercase tracking-[0.15em] text-ink-soft">
              Estd. 2003 · Badlapur, India
            </span>

            <h1 className="hero-reveal font-display text-4xl font-bold leading-[1.08] tracking-tight sm:text-5xl lg:text-[3.4rem]">
              Visibility is your{" "}
              <span className="text-signal">strongest currency.</span>
            </h1>

            <p className="hero-reveal max-w-xl text-lg leading-relaxed text-ink-soft">
            ...
            <div className="hero-reveal grid grid-cols-2 gap-x-8 gap-y-6 border-t border-mist pt-8 sm:grid-cols-4">
              {heroStats.map((s) => (
          ...
          <div className="hero-reveal relative mx-auto w-full max-w-xs sm:max-w-sm">
            ...
            <div className="absolute -bottom-6 -left-4 flex max-w-[75%] flex-col gap-1 rounded-2xl border border-mist bg-paper-raised p-4 shadow-[0_16px_40px_-16px_rgba(20,24,31,0.3)] sm:-left-8">
